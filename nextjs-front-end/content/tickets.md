---
title: "Login Pages for My Tickets System"
draft: false
---
<div style={{ display: 'grid', placeItems: 'center' }}>
  ...
  <button type="submit" style={{ height: '30px', width: '100px', backgroundColor: 'green', color: 'white', border: '1px solid black', borderRadius: '15px', marginTop: '20px' }}>Login</button>
  <div style={{ paddingLeft: '350px' }}>
    <span style={{ marginTop: '10px' }}>[Don't have an account?](./register)</span>
  </div>
</div>
