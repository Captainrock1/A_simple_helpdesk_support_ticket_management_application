          ...
          <div className="row flex-wrap-reverse items-center justify-center lg:flex-row">
            <div className={banner.image_enable ? "mt-12 text-center lg:mt-0 lg:text-left lg:col-6" : "mt-12 text-center lg:mt-0 lg:text-left lg:col-12"}>
              ...
              {banner.button1.enable && (
                  <Link
                    className="btn btn-primary mt-6 ml-6 bg-blue-400"
                    href={banner.button1.link}
                    rel={banner.button1.rel}
                  >
        ...
        <div className="container">
          <div className="row items-start">
            <div className="mb-12 lg:mb-0 lg:col-8">
              {/* Most Sale Tickets */}
              {most_sale_tickets.enable && (
                <div className="section">
                  {markdownify(most_sale_tickets.title, "h2", "section-title")}
              ...
              {/* Recent Posts */}
              {recent_sale_tickets.enable && (
                <div className="section pt-0">
                  {markdownify(recent_sale_tickets.title, "h2", "section-title")}
...
export const getStaticProps = async () => {
  ...
  const { banner, most_sale_tickets, recent_sale_tickets, promotion } = frontmatter;
